...
function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/login" element={token ? <Navigate to="/" /> : <Login setToken={handleLogin} />} />
        <Route path="/signup" element={token ? <Navigate to="/" /> : <Signup setToken={handleLogin} />} />
        <Route path="/" element={token ? <Feed token={token} onLogout={handleLogout} /> : <Navigate to="/login" />} />
        <Route path="/create" element={token ? <CreatePost token={token} onLogout={handleLogout} /> : <Navigate to="/login" />} />
